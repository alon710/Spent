...
**Not running as Administrator?** Setup will continue, but skip the hosts entry. `http://127.0.0.1:2412` still works; `http://spent.local:2412` won't resolve. Re-run setup from an elevated shell later to add the friendly hostname.
</Callout>
